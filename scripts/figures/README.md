...
For anonymous review, include only aggregate artifacts that are permitted by
the data-use agreements. If a figure depends on restricted subject-level RWW
data, provide a de-identified aggregate CSV with patient IDs replaced by stable
